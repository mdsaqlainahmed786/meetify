function FooterComp() {
  return (
    <div className="pb-24 bg-[#1F1F1F] flex items-center justify-between">
      <div className="flex text-white pt-6 flex-wrap gap-11 mx-auto justify-center items-center w-[47vw] md:w-[30vw] lg:w-full lg:justify-around">
        ...
        <span className="font-semibold text-xl text-gray-600">SHOP</span>
          <a
            href="/Men-Suits"
            className="text-md text-white-600 hover:text-black cursor-pointer hover:underline"
          >
            Men Suit
          </a>
          <a
        ...
        <div className="flex flex-col space-y-1 justify-center items-center lg:justify-start lg:items-start">
          ...
          <a
            href="/"
            className="text-md text-white  cursor-pointer hover:underline"
          >
            Contact Us
          </a>
          <a
        ...
        <div className="flex flex-col space-y-1 justify-center items-center lg:justify-start lg:items-start">
          <span className="font-semibold text-xl text-gray-white">
            Customer Service
          </span>
          <a
            href="/"
        ...
        <div className="flex flex-col space-y-1 justify-center items-center lg:justify-start lg:items-start lg:pt-[2rem]">
          <span className="font-semibold text-xl text-white">POLICY</span>
          <a
            href="/"
            className="text-md text-white  cursor-pointer hover:underline"
          >
