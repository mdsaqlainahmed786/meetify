...
export default function Home() {
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="flex justify-between items-center w-full pt-32 mx-auto max-w-[90vw]">
      ...
      <p className="text-3xl pt-44 pb-16 text-center font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">
        Key Features
      </p>
          ...
          <Card className="shadow-md " key={index}>
            <CardHeader>
              <div className="flex justify-center flex-col items-center space-y-5">
                <p className="text-5xl text-center text-blue-600">
                  {feature.icon}
                </p>
                <CardTitle className="text-lg text-center text-blue-600">
                  {feature.title}
                </CardTitle>
                <CardDescription className="text-md text-center text-gray-700">
                  {feature.description}
                </CardDescription>
              </div>
            </CardHeader>
